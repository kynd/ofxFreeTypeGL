...
//--------------------------------------------------------------
void ofxFreeTypeGL::setString(wstring wstr) {
    internalString = wstr;
}

//--------------------------------------------------------------
void ofxFreeTypeGL::setBaseColor(ofColor color) {
    baseColor = color;
}

//--------------------------------------------------------------
void ofxFreeTypeGL::setBaseColor(int r, int g, int b, int a) {
    baseColor = ofColor(r, g, b, a);
}
//--------------------------------------------------------------
void ofxFreeTypeGL::update() {
    ...
    const wchar_t *cache = internalString.c_str();
    //L"Wow,これは面白い!!夜露死苦〠";
...
//--------------------------------------------------------------
void ofxFreeTypeGL::draw(int x, int y){
    ofSetColor(0, 0, 0);
    texture.draw(x,y);
}
//--------------------------------------------------------------